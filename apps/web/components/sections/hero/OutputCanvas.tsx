...
export function OutputCanvas({ cycle }: Props) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden bg-[var(--color-cream-warm)]">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="relative flex min-h-0 flex-1 flex-col overflow-hidden px-6 pt-6 pb-6 sm:px-9 sm:pt-7"
        >
    ...
    <div ref={containerRef} className="relative">
      ...
      <motion.div
        ...
        style={{
          ...
          width: 1.5,
          background: 'var(--color-ink-3)', // subtle grey line
        }}
        initial={{ height: 0 }}
    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          className="relative h-full w-full rounded-full border-[1.5px] border-[var(--color-ink)] bg-[var(--color-paper)]"
        >
          {isCurrent ? (
            <motion.span
              aria-hidden
              className="pointer-events-none absolute inset-0 rounded-full border-[1.5px] border-[var(--color-ink)]"
