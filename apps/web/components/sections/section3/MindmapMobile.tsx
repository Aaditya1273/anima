    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        {ENIGMA.recentActivity.map(item => (
          ...
          >
            <span className="font-mono text-[10px] tracking-[0.04em] text-[var(--color-ink-3)]">
              {item.kind}
            </span>
...
function UptimeRow() {
  ...
  const s = delta % 60
  return (
    <div className="font-mono mt-3 flex items-baseline justify-between text-[10.5px] tracking-[0.04em] text-[var(--color-ink-3)]">
      <span>Uptime</span>
